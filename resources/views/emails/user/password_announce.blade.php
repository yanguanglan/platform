											...
											<table class="twelve columns" style="border-spacing: 0; border-collapse: collapse; padding: 0; vertical-align: top; text-align: left; width: 92%; margin: 0 auto;">
												<tr style="padding: 0; vertical-align: top; text-align: left;">
													<td class="panel center" style="font-family: 'Helvetica', 'Arial', sans-serif; word-break: break-word; -moz-hyphens: auto; hyphens: auto; font-size: 14px; line-height: 19px; vertical-align: top; margin: 0; color: #222222; -webkit-hyphens: auto; font-weight: normal; border: 1px solid #d9d9d9; text-align: center; background: #FFFFFF; border-color: transparent; box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12); border-radius: 2px; padding: 20px 25px; border-collapse: collapse;">
														<h2 class="center" style="color: #212121; font-family: 'Roboto', Arial; font-weight: 400; padding: 0; margin: 0; line-height: 30px; word-break: normal; font-size: 24px; text-align: center;">Password Update</h2>
														<hr style="color: #d9d9d9; height: 1px; border: none; margin: 15px 0; border-bottom: 1px solid #979797; box-shadow: none;">
														<p class="center" style="margin: 0; color: #212121; font-family: 'Roboto', Arial; font-weight: normal; padding: 0; line-height: 150%; font-size: 16px; margin-bottom: 10px; text-align: center;">Dear {{$user->name}},<br>your password was updated successfully! Go back to AngularJS Recipes and have some fun!</p>
														<a href="http://angularjs-recipes.com/" target="_blank" class="btn" style="font-family: 'Roboto', Arial; font-size: 16px; line-height: 150%; border-radius: 2px; text-transform: uppercase; background-color: #d0021b; text-decoration: none; box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12); padding: 12px 30px; display: inline-block; margin: 5px 0 10px; color: #FFFFFF;">Go Back</a>
													</td>
