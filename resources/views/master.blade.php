...
<body class="fixed-footer" ng-app="app">
	...
	<div class="menu-layer">
		<ul>
			...
			<li>
				...
				<ul class="child-menu">
					<li><a href="{{route('recipes.index', ['filter' => 'version'])}}">Version</a></li>
					<li><a href="{{route('recipes.index', ['filter' => 'topic'])}}">Topic</a></li>
				</ul>
			</li>
			<li>
			...
			<li>
				...
				<ul class="child-menu">
					...
					<li><a href="https://angular.io/" target="_blank">AngularJS 2</a></li>
				</ul>
			</li>
			<li>
